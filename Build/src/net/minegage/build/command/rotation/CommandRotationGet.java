...
public class CommandRotationGet
		extends CommandModule<RotationManager> {
		
	public CommandRotationGet(RotationManager manager) {
		super(manager, Rank.ADMIN, "get", "fetch", "download");
	}
