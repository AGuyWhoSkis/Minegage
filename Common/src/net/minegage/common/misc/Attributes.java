 ...
 * @author aadnk, Skis
 * 		
 *         Source: https://gist.github.com/aadnk/5943946. Edited by Skis.
 *         <p>
 *         Example use: https://bitbucket.org/snippets/lebroncraft/jgxj7/attributes-example.git
 */
public class Attributes {
	...
	public static class Attribute {
		...
		public static class Builder {
			...
			private Builder() {
				// Static factory method used instead
			}
	...
	private NBTTagList attributeList;
	...
	public Attributes(ItemStack stack) {
		...
		if (!nmsStack.hasTag()) {
			...
			nmsStack.setTag(parentNBT);
		} else {
			parentNBT = nmsStack.getTag();
		}
		
		// List types:
		// 0:"END", 1:"BYTE", 2:"SHORT", 3:"INT", 4:"LONG", 5:"FLOAT", 6:"DOUBLE", 7:"BYTE[]",
		// 8:"STRING", 9:"LIST", 10:"COMPOUND", 11:"INT[]"
		
		// Load attribute list
		if (parentNBT.hasKey("AttributeModifiers")) {
			attributeList = parentNBT.getList("AttributeModifiers", 10);
		} else {
			attributeList = new NBTTagList();
			parentNBT.set("AttributeModifiers", attributeList);
		}
	}
	...
	public void add(Attribute attribute) {
		attributeList.add(attribute.data);
	}
	...
	public void clear() {
		parentNBT.set("AttributeModifiers", attributeList = new NBTTagList());
	}
	...
	private <T> List<T> getList() {
		try {
			...
			return (List<T>) listField.get(attributeList);
